...
BUILDFILE = 'https://pastebin.ai/raw/caslcxr08z'
...
ADVANCEDFILE = 'http://'
# TIMEOUT value for Opening URL's
TIMEOUT = 60.00
#########################################################
...
REPOZIPURL = 'https://github.com/slrwin/sunnyrepo/blob/master/repository.sunnyrepo-2.0.3.zip?raw=true'
#########################################################
